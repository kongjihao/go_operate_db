...
func zsetDemo() {
	...
	if err != nil {
		println("Error adding elements to zset(language_rank):", err)
	}
	...
	languageInRange, _ := rdb.ZRangeByScore(zsetKey, zRangeBy).Result()
	println("Languages with scores between", min, "and", max, ":")
